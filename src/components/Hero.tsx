...
export function Hero({ onStart }: HeroProps) {
    ...
    return (
        <section id="home" className="relative w-full min-h-screen bg-white overflow-hidden font-sans">
            <div className="animation-delay-8 animate-fadeIn mt-20 flex flex-col items-center justify-center px-4 text-center md:mt-20 z-10 relative">
                <div className="z-10 mb-6 mt-10 sm:justify-center md:mb-4 md:mt-20">
                    <div className="relative flex items-center whitespace-nowrap rounded-full border bg-popover px-3 py-1 text-xs leading-6 text-primary/60 ">
                        <Shapes className="h-5 p-1" /> Introducing HexaStack.
                        <a
                            href="#"
                            rel="noreferrer"
                ...
                <div className="mb-10 mt-4 md:mt-6">
                    <div className="px-2">
                        <div className="border-ali relative mx-auto h-full max-w-7xl border p-6 [mask-image:radial-gradient(800rem_96rem_at_center,white,transparent)] md:px-12 md:py-20">
                            <h1 className="flex select-none flex-col px-3 py-2 text-center text-5xl font-semibold leading-none tracking-tight md:flex-col md:text-8xl lg:flex-row lg:text-8xl">
                                <Plus
                                    strokeWidth={4}
                                    className="text-ali absolute -left-5 -top-5 h-10 w-10 text-primary"
                                />
                                <Plus
                                    strokeWidth={4}
                                    className="text-ali absolute -bottom-5 -left-5 h-10 w-10 text-primary"
                                />
                                <Plus
                                    strokeWidth={4}
                                    className="text-ali absolute -right-5 -top-5 h-10 w-10 text-primary"
                                />
                                <Plus
                                    strokeWidth={4}
                                    className="text-ali absolute -bottom-5 -right-5 h-10 w-10 text-primary"
                                />
                    ...
                    <div className="flex justify-center gap-2">
                        ...
                        <a href="https://cal.com/aliimam/designali" target="_blank" rel="noreferrer">
